...
public class Replica_Manager_Listener implements Runnable, ServerInterface{
    ...
    public void run() {
        ...
        try {
            ...
            socket = new DatagramSocket(ReplicaManager3.LOCAL_PORT); // port: 5000
            while (true) {
                ...
                ReplicaManager3.REQUEST_HASH_TABLE.put(request_ID, new String(request.getData()).trim().toString());
                ...
                ReplicaManager3.REQUEST_HASH_TABLE.remove(request_ID);
