...
public class Replica_Manager_Listener implements Runnable, ServerInterface{
    ...
    public void run() {
        ...
        try {
            ...
            socket = new DatagramSocket(ReplicaManager2.LOCAL_PORT); // port: 5000
            while (true) {
                ...
                ReplicaManager2.REQUEST_HASH_TABLE.put(request_ID, new String(request.getData()).trim().toString());
                ...
                ReplicaManager2.REQUEST_HASH_TABLE.remove(request_ID);
