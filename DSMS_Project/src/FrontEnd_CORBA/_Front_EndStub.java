 ...
 */
public class _Front_EndStub extends org.omg.CORBA.portable.ObjectImpl
        implements Front_End
{
    static final String[] _ids_list =
    {
        "IDL:FrontEnd_CORBA/Front_End:1.0"
    };
    ...
    private final static Class _opsClass = FrontEnd_CORBA.Front_EndOperations.class;
    ...
    public String createDRecord(String managerID, String firstName, String lastName, String address, String phone, String specialization, String location)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if (_so == null)
                   continue;
                FrontEnd_CORBA.Front_EndOperations _self = (FrontEnd_CORBA.Front_EndOperations) _so.servant;
                try
                {
